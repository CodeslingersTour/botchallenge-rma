...
const { RmaTicketLuis } = require('./rma-ticket-luis');
const { RmaQnA } = require('./rma-qna');
...
class DispatchBot {
    ...
    constructor(conversationState, userState, botConfig) {
        ...
        this.rmaTicketDialog = new RmaTicketLuis(conversationState, userState, botConfig);
        this.rmaQnaDialog = new RmaQnA(botConfig);
            ...
            if (turnContext.activity.membersAdded.length !== 0) {
                ...
                for (var idx in turnContext.activity.membersAdded) {
                    ...
                    if (turnContext.activity.membersAdded[idx].id !== turnContext.activity.recipient.id) {
                        ...
                        await turnContext.sendActivity(`Hello, I'm Rosy the bot!`);
                        await turnContext.sendActivity(`You can ask me FAQs or tell me to 'create an RMA ticket for a laptop' or 'Lookup RMA ticket 895784625'`);
                    }
                }
            }
        }
...
module.exports.RmaBot = DispatchBot;
