...
const RMA_TICKET_LUIS_STATE_PROPERTY = 'rmaTicket.state';
...
class RmaTicketLuisState {
    ...
    constructor(conversationState, userState) {
        ...
        this.deviceProperty = conversationState.createProperty(RMA_TICKET_LUIS_STATE_PROPERTY);
    }
...
module.exports.RmaTicketLuisState = RmaTicketLuisState;
